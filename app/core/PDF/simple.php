...
// SHIPPING INFO
foreach ($this->shipping as $c) { $this->data .= $c."<br>"; }
$this->data .= "</td><td>";
...
// (E) ITEMS
$this->data .= "<table id='items'><tr><th>Item</th><th>Delivered</th><th>Unit Price</th><th>Amount</th></tr>";
