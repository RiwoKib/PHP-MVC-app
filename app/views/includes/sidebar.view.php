...
$controller = $urlSegments[count($urlSegments) - 3];
$controllerMethod = $urlSegments[count($urlSegments) - 2] . "/". $active_nav;
?>
    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    <a <?= $controller == 'products' ? 'class="active"' : ($controller == 'categories' ? 'class="active"' : ($controller == 'brands' ? 'class="active"' : ($controller == 'subcategories' ? 'class="active"' : '')))?> href="javascript:void(0);">
                    ...
                    <ul>
                        ...
                        <li><a <?= $controllerMethod == 'products/add' ? 'class="active"' : ''?> href="<?=ROOT?>/products/add ">Add Product</a></li>
                        <li><a <?= $active_nav == 'categories' ? 'class="active"' : ''?> href="<?=ROOT?>/categories">Category List</a></li>
                        <li><a <?= $controllerMethod == 'categories/add' ? 'class="active"' : ''?> href="<?=ROOT?>/categories/add">Add Category</a></li>
                        <li><a <?= $active_nav == 'subcategories' ? 'class="active"' : ''?> href="<?=ROOT?>/subcategories">Sub Category List</a></li>
                        <li><a <?= $controllerMethod == 'subcategories/add' ? 'class="active"' : ''?> href="<?=ROOT?>/subcategories/add">Add Sub Category</a></li>
                        <li><a <?= $active_nav == 'brands' ? 'class="active"' : ''?> href="<?=ROOT?>/brands ">Brand List</a></li>
                        <li><a <?= $controllerMethod == 'brands/add' ? 'class="active"' : ''?> href="<?=ROOT?>/brands/add">Add Brand</a></li>
                        <li><a <?= $controllerMethod == 'products/import' ? 'class="active"' : ''?> href="<?=ROOT?>/products/import">Import Products</a></li>
                        <li><a <?= $controllerMethod == 'products/barcode' ? 'class="active"' : ''?> href="<?=ROOT?>/products/barcode">Print Barcode</a></li>
                    </ul>
                </li>

                <li class="submenu">
                    <a <?= $controller == 'sales' ? 'class="active"' : ''?> href="javascript:void(0);">
                    ...
                    <ul>
                        ...
                        <li><a href="<?=ROOT?>/sales/add" <?= $controllerMethod == 'sales/add' ? 'class="active"' : ''?>>New Sales</a></li>
                       </ul>
                </li>

                <li class="submenu">
                    <a <?= $controller == 'purchases' ? 'class="active"' : ''?> href="javascript:void(0);">
                    ...
                    <ul>
                        ...
                        <li><a href="<?=ROOT?>/purchases/add" <?= $controllerMethod == 'purchases/add' ? 'class="active"' : ''?>>Add Purchase</a></li>
                        <li><a href="<?=ROOT?>/purchases/import" <?= $controllerMethod == 'purchases/import' ? 'class="active"' : ''?>>Import Purchase</a></li>
                    </ul>
                </li>

                <li class="submenu">
                    <a <?= $controller == 'expenses' ? 'class="active"' : ''?> href="javascript:void(0);">
                    ...
                    <ul>
                        ...
                        <li><a href="<?=ROOT?>/expenses/add" <?= $controllerMethod == 'expenses/add' ? 'class="active"' : ''?>>Add Expense</a></li> 
                    </ul>
                </li>

                <li class="submenu">
                    <a <?= $controller == 'quotations' ? 'class="active"' : ''?> href="javascript:void(0);">
                    ...
                    <ul>
                        ...
                        <li><a href="<?=ROOT?>/quotations/add" <?= $controllerMethod == 'quotations/add' ? 'class="active"' : ''?>>Add Quotation</a></li>
                    </ul>
                </li>

                <li class="submenu">
                    <a <?= $controller == 'transfers' ? 'class="active"' : ''?> href="javascript:void(0);">
                    ...
                    <ul>
                        ...
                        <li><a href="<?=ROOT?>/transfers/add" <?= $controllerMethod == 'transfers/add' ? 'class="active"' : ''?>>Add Transfer </a></li>
                        <li><a href="<?=ROOT?>/transfers/import" <?= $controllerMethod == 'transfers/import' ? 'class="active"' : ''?>>Import Transfer </a></li>
                    </ul>
                </li>
                ...
                <li class="submenu">
                    ...
                    <ul> 
                        ...
                        <li><a href="<?=ROOT?>/salesreturn/add" <?= $controllerMethod == 'salesreturn/add' ? 'class="active"' : ''?>>New Sales Return</a></li>
                        <li><a href="<?=ROOT?>/purchasereturns" <?= $active_nav == 'purchasereturns' ? 'class="active"' : ''?>>Purchase Return List</a></li>
                        <li><a href="<?=ROOT?>/purchasereturns/add" <?= $controllerMethod == 'purchasereturns/add' ? 'class="active"' : ''?>>Add Purchase Return </a></li>
                    </ul>
                </li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="<?=ROOT?>/customers/add" <?= $controllerMethod == 'customers/add' ? 'class="active"' : ''?>>Add Customer </a></li>
                        <li><a href="<?=ROOT?>/suppliers" <?= $active_nav == 'suppliers' ? 'class="active"' : ''?>>Supplier List</a></li>
                        <li><a href="<?=ROOT?>/suppliers/add" <?= $controllerMethod == 'suppliers/add' ? 'class="active"' : ''?>>Add Supplier </a></li>  
                    </ul>
                </li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="<?=ROOT?>/countries/add" <?= $controllerMethod == 'countries/add' ? 'class="active"' : ''?>>New Country</a></li>
                        <li><a href="<?=ROOT?>/countries" <?= $active_nav == 'countries' ? 'class="active"' : ''?>>Countries list</a></li>
                        <li><a href="<?=ROOT?>/cities/add" <?= $controllerMethod == 'cities/add' ? 'class="active"' : ''?>>New City </a></li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="<?=ROOT?>/purchases/report" <?= $controllerMethod == 'purchases/report' ? 'class="active"' : ''?>>Purchase order report</a></li>
                        <li><a href="<?=ROOT?>/inventory" <?= $active_nav == 'inventory' ? 'class="active"' : ''?>>Inventory Report</a></li>
                        <li><a href="<?=ROOT?>/sales/report" <?= $controllerMethod == 'sales/report' ? 'class="active"' : ''?>>Sales Report</a></li>
                        <li><a href="<?=ROOT?>/sales/invoice" <?= $controllerMethod == 'sales/invoice' ? 'class="active"' : ''?>>Invoice Report</a></li> 
                        <li><a href="<?=ROOT?>/suppliers/report" <?= $controllerMethod == 'suppliers/report' ? 'class="active"' : ''?>>Supplier Report</a></li>
                        <li><a href="<?=ROOT?>/customers/report" <?= $controllerMethod == 'customers/report' ? 'class="active"' : ''?>>Customer Report</a></li>
                    </ul>
                </li>
