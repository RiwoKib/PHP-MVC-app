                            ...
                            <?php if(isset($rows) && $rows){?>
                                <?php foreach($rows as $quote){?>
                                    <tr>
                                        ...
                                        <td>
                                            <a data-bs-toggle="tooltip" data-bs-placement="bottom" class="me-3" title="details" href="<?=ROOT?>/quotations/quote_details/<?=$quote->id?>">
                                                <img src="<?=ASSETS?>/img/icons/eye.svg" alt="img">
                                            </a>
                                            <a data-bs-toggle="tooltip" data-bs-placement="bottom" class="me-3" title="delete" href="javascript:void(0);">
